...
**Produto (Gestão Comercial):** outras IAs devem ler [HANDOFF.md](HANDOFF.md) e
[AGENTS.project.md](AGENTS.project.md). O restante deste arquivo é o contrato do
**sandbox Grok** (preview, portas, skills) — não é o manual do ERP.
